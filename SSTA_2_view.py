...
def training(N, Nte, bs, n_epoch, act, data_mode, args):
    ...
    for epoch in range(1, n_epoch + 1):
        ...
        if args.mode == 'eval' and epoch % 20 == 0:  # 20
            batch_id = 0
...
if __name__ == "__main__":
    ...
    parser.add_argument('--eval_num_step', type=int, default=500)
    parser.add_argument('--eval_per_step', type=int, default=23)
    parser.add_argument('--mask_per_step', type=int, default=1000000000)
    parser.add_argument('--log_per_epoch', type=int, default=10)
    parser.add_argument('--num_step', type=int, default=23)
    ...
    parser.add_argument('--ckpt_dir', type=str, default='results/20220717-195317/carla_town02_8_view_20220713_color_split_2/', help='checkpoint dir: dir/model_1.pt, 20220717-195317')
