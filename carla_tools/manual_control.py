...
class World(object):
    ...
    def restart(self):
        ...
        while self.player is None:
            ...
            print('len(car spawn points): ', len(spawn_points))
            # print(spawn_points)
        ...
        self.camera_manager = CameraManager(self.player, self.hud, self._gamma, args=self.args)
...
class CameraManager(object):
    def __init__(self, parent_actor, hud, gamma_correction, args):
        ...
        self._camera_transforms = [
            (carla.Transform(carla.Location(x=spectator_transform.location.x,
            ...
            (carla.Transform(carla.Location(x=-8.0, z=20.0), carla.Rotation(pitch=6.0)), Attachment.SpringArm),
    ...
    def set_sensor(self, index, notify=True, force_respawn=False):
        ...
        if needs_respawn:
            if self.sensor is not None:
                self.sensor.destroy()
                self.surface = None
            # print(self._camera_transforms[self.transform_index])
            if len(self._camera_transforms[self.transform_index]) == 1:
